...
## [0.20.0](https://github.com/statrs-dev/statrs/compare/v0.19.1...v0.20.0) - 2026-09-23
...
- sample Gumbel via -ln(U), not ln(-U)
...
- Handle p=1 in NegativeBinomial::ln_pmf like Binomial
- Fixed broken Wikipedia link and changed link so it doesn't necessarily default to English
