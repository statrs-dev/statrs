...
use nalgebra::{
    base::allocator::Allocator, Cholesky, Const, DefaultAllocator, Dim, DimMin, OMatrix, OVector,
};
use rand::Rng;
use std::f64;
...
///
/// let mvn = MultivariateNormal::new(vector![0., 0.], matrix![1., 0.; 0., 1.]).unwrap();
        ...
        + nalgebra::allocator::Allocator<(usize, usize), D>,
{
    ...
    pub fn new(mean: OVector<f64, D>, cov: OMatrix<f64, D, D>) -> Result<Self> {
